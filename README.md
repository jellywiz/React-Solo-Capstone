...
**[Metrics webapp]** is a react web application for retriving crypto currency
...
- **View Different Crypto Currency**
- **View Detail About Each Coin**
...
`git clone https://github.com/jellywiz/React-Solo-Capstone.git`
